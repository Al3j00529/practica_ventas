...
Si prefieres calcular el total desde tu código JavaScript, modifica la tabla
ventas con este comando SQL:
ALTER TABLE ventas MODIFY COLUMN total DECIMAL(10,2);
Con eso, el campo total dejará de ser generado automáticamente y podrás
insertar el valor desde Node.js como lo hacías:
const total = precio * cantidad;
...
[precio, total]